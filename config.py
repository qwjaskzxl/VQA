...
preprocessed_path = './dataset/resnet152_totOri-14x14.h5'  # path where preprocessed features are saved to and loaded from
...
golov_pretrain_path = './dataset/glove.6B.300d.pkl'
task = 'OpenEnded'
dataset = 'mscoco'
# preprocess config
