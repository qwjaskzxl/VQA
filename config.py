...
train_path = 'dataset/Images/train2014/train2014'  # directory of training images
val_path = 'dataset/Images/train2014/train2014'  # directory of validation images
test_path = 'dataset/Images/test2015/test2015'  # directory of test images
